...
> Иногда этот размер и называют разрешением (resolution), в том числе и в разного рода вполне официальных документах. Это создаёт путаницу. Лучше разрешением называть именно разрешение, о нём ниже.
